...
HD_PWD='D:/Dragoncore/PipeLine/PipeLine.runs/AXI_RAM_I_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_RAM_I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_RAM_I.tcl
